use crate::{
    ...
    manifest::{
        ...
        ModelPolicy, MountConfig, NetworkRule, PARCEL_FORMAT_VERSION, PARCEL_SCHEMA_URL,
        ParcelFileRecord, ParcelManifest, SecretSpec, TestSpec, TimeoutSpec, ToolConfig,
        ToolInputSchemaRef, Visibility, WasmComponentConfig,
    },
    parse_agentfile,
    skill::{
...
mod tests {
    use super::*;
    use crate::{A2aAuthConfig, A2aAuthScheme, A2aEndpointMode, ToolApprovalPolicy, ToolRiskLevel};
