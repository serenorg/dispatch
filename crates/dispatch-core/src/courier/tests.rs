...
fn build_test_plugin_courier(
    ...
    let script = if error_mode {
        "#!/bin/sh\ncat >/dev/null\nprintf '%s\\n' '{\"jsonrpc\":\"2.0\",\"id\":1,\"error\":{\"code\":-32000,\"message\":\"plugin rejected request\",\"data\":{\"dispatch_error\":{\"code\":\"bad_request\",\"message\":\"plugin rejected request\"}}}}'\n"
                .to_string()
    } else {
        format!(
            "#!/bin/sh\nwhile IFS= read -r request; do\ncase \"$request\" in\n*'\"method\":\"courier.capabilities\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"capabilities\",\"capabilities\":{{\"courier_id\":\"demo-plugin\",\"kind\":\"custom\",\"supports_chat\":true,\"supports_job\":false,\"supports_heartbeat\":false,\"supports_local_tools\":false,\"supports_mounts\":[]}}}}}}'\n;;\n*'\"method\":\"courier.validate_parcel\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"ok\"}}}}'\n;;\n*'\"method\":\"courier.inspect\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"inspection\",\"inspection\":{{\"courier_id\":\"demo-plugin\",\"kind\":\"custom\",\"entrypoint\":\"chat\",\"required_secrets\":[],\"mounts\":[],\"local_tools\":[]}}}}}}'\n;;\n*'\"method\":\"courier.open_session\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"session\",\"session\":{{\"id\":\"plugin-session\",\"parcel_digest\":\"{digest}\",\"entrypoint\":\"chat\",\"turn_count\":0,\"history\":[],\"backend_state\":\"open\"}}}}}}'\n;;\n*'\"method\":\"courier.resume_session\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"session\",\"session\":{{\"id\":\"plugin-session\",\"parcel_digest\":\"{digest}\",\"entrypoint\":\"chat\",\"turn_count\":1,\"history\":[{{\"role\":\"user\",\"content\":\"hello plugin\"}},{{\"role\":\"assistant\",\"content\":\"from plugin\"}}],\"backend_state\":\"warm|resumed\"}}}}}}'\n;;\n*'\"method\":\"courier.shutdown\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"ok\"}}}}'\nexit 0\n;;\n*'\"method\":\"courier.run\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"method\":\"courier.event\",\"params\":{{\"kind\":\"event\",\"event\":{{\"kind\":\"message\",\"role\":\"assistant\",\"content\":\"from plugin\"}}}}}}'\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"done\",\"session\":{{\"id\":\"plugin-session\",\"parcel_digest\":\"{digest}\",\"entrypoint\":\"chat\",\"turn_count\":1,\"history\":[{{\"role\":\"user\",\"content\":\"hello plugin\"}},{{\"role\":\"assistant\",\"content\":\"from plugin\"}}],\"backend_state\":\"turns:1\"}}}}}}'\n;;\n*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"error\":{{\"code\":-32000,\"message\":\"unexpected request\",\"data\":{{\"dispatch_error\":{{\"code\":\"bad_request\",\"message\":\"unexpected request\"}}}}}}}}'\n;;\nesac\ndone\n"
        )
    };
...
fn build_test_counting_plugin_courier(
    ...
    let script = format!(
        "#!/bin/sh\nprintf 'started\\n' >> '{}'\nwhile IFS= read -r request; do\ncase \"$request\" in\n*'\"method\":\"courier.capabilities\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"capabilities\",\"capabilities\":{{\"courier_id\":\"demo-counting-plugin\",\"kind\":\"custom\",\"supports_chat\":true,\"supports_job\":false,\"supports_heartbeat\":false,\"supports_local_tools\":false,\"supports_mounts\":[]}}}}}}'\n;;\n*'\"method\":\"courier.open_session\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"session\",\"session\":{{\"id\":\"plugin-session-counting\",\"parcel_digest\":\"{digest}\",\"entrypoint\":\"chat\",\"turn_count\":0,\"history\":[],\"backend_state\":\"open\"}}}}}}'\n;;\n*'\"method\":\"courier.resume_session\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"session\",\"session\":{{\"id\":\"plugin-session-counting\",\"parcel_digest\":\"{digest}\",\"entrypoint\":\"chat\",\"turn_count\":1,\"history\":[{{\"role\":\"user\",\"content\":\"first\"}},{{\"role\":\"assistant\",\"content\":\"from plugin turn 1\"}}],\"backend_state\":\"turns:1|resumed\"}}}}}}'\n;;\n*'\"method\":\"courier.shutdown\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"ok\"}}}}'\nexit 0\n;;\n*'\"method\":\"courier.run\"'*)\ncase \"$request\" in\n*'\"turn_count\":1'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"method\":\"courier.event\",\"params\":{{\"kind\":\"event\",\"event\":{{\"kind\":\"message\",\"role\":\"assistant\",\"content\":\"from plugin turn 2\"}}}}}}'\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"done\",\"session\":{{\"id\":\"plugin-session-counting\",\"parcel_digest\":\"{digest}\",\"entrypoint\":\"chat\",\"turn_count\":2,\"history\":[{{\"role\":\"user\",\"content\":\"first\"}},{{\"role\":\"assistant\",\"content\":\"from plugin turn 1\"}},{{\"role\":\"user\",\"content\":\"second\"}},{{\"role\":\"assistant\",\"content\":\"from plugin turn 2\"}}],\"backend_state\":\"turns:2\"}}}}}}'\n;;\n*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"method\":\"courier.event\",\"params\":{{\"kind\":\"event\",\"event\":{{\"kind\":\"message\",\"role\":\"assistant\",\"content\":\"from plugin turn 1\"}}}}}}'\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"done\",\"session\":{{\"id\":\"plugin-session-counting\",\"parcel_digest\":\"{digest}\",\"entrypoint\":\"chat\",\"turn_count\":1,\"history\":[{{\"role\":\"user\",\"content\":\"first\"}},{{\"role\":\"assistant\",\"content\":\"from plugin turn 1\"}}],\"backend_state\":\"turns:1\"}}}}}}'\n;;\nesac\n;;\n*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"error\":{{\"code\":-32000,\"message\":\"unexpected request\",\"data\":{{\"dispatch_error\":{{\"code\":\"bad_request\",\"message\":\"unexpected request\"}}}}}}}}'\n;;\nesac\ndone\n",
        starts_path.display()
    );
    fs::write(&plugin_path, &script).unwrap();
    fs::set_permissions(&plugin_path, fs::Permissions::from_mode(0o755)).unwrap();
...
fn build_test_slow_plugin_courier(dir: &tempfile::TempDir, digest: &str) -> JsonlCourierPlugin {
    ...
    let script = format!(
        "#!/bin/sh\nwhile IFS= read -r request; do\ncase \"$request\" in\n*'\"method\":\"courier.capabilities\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"capabilities\",\"capabilities\":{{\"courier_id\":\"demo-slow-plugin\",\"kind\":\"custom\",\"supports_chat\":true,\"supports_job\":false,\"supports_heartbeat\":false,\"supports_local_tools\":false,\"supports_mounts\":[]}}}}}}'\n;;\n*'\"method\":\"courier.open_session\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"session\",\"session\":{{\"id\":\"plugin-session-slow\",\"parcel_digest\":\"{digest}\",\"entrypoint\":\"chat\",\"turn_count\":0,\"history\":[],\"backend_state\":\"open\"}}}}}}'\n;;\n*'\"method\":\"courier.resume_session\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"session\",\"session\":{{\"id\":\"plugin-session-slow\",\"parcel_digest\":\"{digest}\",\"entrypoint\":\"chat\",\"turn_count\":0,\"history\":[],\"backend_state\":\"open|resumed\"}}}}}}'\n;;\n*'\"method\":\"courier.shutdown\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"ok\"}}}}'\nexit 0\n;;\n*'\"method\":\"courier.run\"'*)\nsleep 0.2\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"done\",\"session\":{{\"id\":\"plugin-session-slow\",\"parcel_digest\":\"{digest}\",\"entrypoint\":\"chat\",\"turn_count\":1,\"history\":[{{\"role\":\"user\",\"content\":\"hello\"}},{{\"role\":\"assistant\",\"content\":\"slow reply\"}}],\"backend_state\":\"turns:1\"}}}}}}'\n;;\n*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"error\":{{\"code\":-32000,\"message\":\"unexpected request\",\"data\":{{\"dispatch_error\":{{\"code\":\"bad_request\",\"message\":\"unexpected request\"}}}}}}}}'\n;;\nesac\ndone\n"
    );
    fs::write(&plugin_path, &script).unwrap();
    fs::set_permissions(&plugin_path, fs::Permissions::from_mode(0o755)).unwrap();
...
fn build_test_shutdown_plugin_courier(
    ...
    let script = format!(
        "#!/bin/sh\nwhile IFS= read -r request; do\ncase \"$request\" in\n*'\"method\":\"courier.open_session\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"session\",\"session\":{{\"id\":\"plugin-session-shutdown\",\"parcel_digest\":\"{digest}\",\"entrypoint\":\"chat\",\"turn_count\":0,\"history\":[],\"backend_state\":\"open\"}}}}}}'\n;;\n*'\"method\":\"courier.run\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"method\":\"courier.event\",\"params\":{{\"kind\":\"event\",\"event\":{{\"kind\":\"message\",\"role\":\"assistant\",\"content\":\"from shutdown plugin\"}}}}}}'\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"done\",\"session\":{{\"id\":\"plugin-session-shutdown\",\"parcel_digest\":\"{digest}\",\"entrypoint\":\"chat\",\"turn_count\":1,\"history\":[{{\"role\":\"user\",\"content\":\"hello\"}},{{\"role\":\"assistant\",\"content\":\"from shutdown plugin\"}}],\"backend_state\":\"turns:1\"}}}}}}'\n;;\n*'\"method\":\"courier.shutdown\"'*)\nprintf 'shutdown\\n' >> '{}'\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"ok\"}}}}'\nexit 0\n;;\n*'\"method\":\"courier.capabilities\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"capabilities\",\"capabilities\":{{\"courier_id\":\"demo-shutdown-plugin\",\"kind\":\"custom\",\"supports_chat\":true,\"supports_job\":false,\"supports_heartbeat\":false,\"supports_local_tools\":false,\"supports_mounts\":[]}}}}}}'\n;;\n*'\"method\":\"courier.validate_parcel\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"ok\"}}}}'\n;;\n*'\"method\":\"courier.inspect\"'*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"result\":{{\"kind\":\"inspection\",\"inspection\":{{\"courier_id\":\"demo-shutdown-plugin\",\"kind\":\"custom\",\"entrypoint\":\"chat\",\"required_secrets\":[],\"mounts\":[],\"local_tools\":[]}}}}}}'\n;;\n*)\nprintf '%s\\n' '{{\"jsonrpc\":\"2.0\",\"id\":1,\"error\":{{\"code\":-32000,\"message\":\"unexpected request\",\"data\":{{\"dispatch_error\":{{\"code\":\"bad_request\",\"message\":\"unexpected request\"}}}}}}}}'\n;;\nesac\ndone\n",
